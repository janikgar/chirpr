...
class ChirpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chirp" do
    assert_difference('Chirp.count') do
      post chirps_url, params: { chirp: { message: @chirp.message, user_id: @chirp.user_id } }
    end
  ...
  test "should update chirp" do
    patch chirp_url(@chirp), params: { chirp: { message: @chirp.message, user_id: @chirp.user_id } }
